                ...
                <div class="col-md-4">
                    <div class="shadow card mb-4">
                        <div class="d-flex flex-wrap">
                            ...
                            class="card-img-top">
                            <h4 class="text-image position-absolute" style="padding-right: 10px; padding-left: 10px; marg">{{$content->city->name}}</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="shadow card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('detailBdy', [$budaya->city->province->slug, $budaya->city->slug,
